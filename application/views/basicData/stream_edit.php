...
<div class="card shadow p-0 m-0">
     <?php echo form_open("BasicData/edit_stream/".$stream["stream_ID"]) ?>

        <div class="card-header py-3 ">
            <h6 class="m-0 font-weight-bold text-primary">Edit Stream  </h6>
        </div>
        <div class="card-body p-2">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                      ...
                      <select name="dept_code" name="dept_code" class="form-control">
                                    ...
                                    foreach ($departments as $f) {
                                           $selected =( ($f['dept_code'] == $this->input->post('dept_code'))||$f['dept_code']==$stream['dept_code'] )? 'selected="selected"' : "";
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="text" name="stream_name" value="<?php echo $this->input->post('stream_name')?$this->input->post('stream_name'):$stream['stream_name']; ?>" class="form-control" id="stream_name" required=""/>
               <span class="text-danger"><?php echo form_error('stream_name'); ?></span>
                </div>
            </div>
            <div class="form-group text-center">
                <input type="submit" name="save_stream" value="Save" class="btn btn-success"/> 
