...
<div class="card shadow p-0 m-0">
     <?php echo form_open('BasicData/edit_department/' . $department['dept_code']); ?>
        ...
        <div class="card-body p-2">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="text" name="dept_name" value="<?php echo ($this->input->post('dept_name') ? $this->input->post('dept_name') : $department['dept_name']); ?>" class="form-control" id="dept_name" required=""/>
                ...
                <div class="form-group">
                      ...
                      <select name="fac_code" name="fac_code" class="form-control">
                                    ...
                                    foreach ($faculties as $f) {
                                        $selected =( ($f['faculity_code'] == $this->input->post('faculity_code'))||$f['faculity_code']==$department['faculity_code'] )? 'selected="selected"' : "";
