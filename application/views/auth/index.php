...
<div class="card shadow mb-4">
    <div class="card-header py-1 row">
        <div class="m-0 font-weight-bold text-primary col-md-6">User account list</div>
        <div class="col-md-6 text-right" >  
            
           <a class="btn btn-success" href="<?php echo site_url("auth/create_user") ?>"><?php echo lang('index_create_user_link')  ?> </a>
                ...
                <tbody>
                    ...
                    foreach ($users as $user):
                        ...
                        <tr><td> <?php echo $i++ ?> </td>
                            ...
                            <td><?php echo ($user->active) ? anchor("auth/deactivate/" . $user->id, lang('index_active_link'),$atributes) : anchor("auth/activate/" . $user->id, lang('index_inactive_link'),$atribute2); ?></td>
                            <td><?php  
                            echo anchor("auth/edit_user/" . $user->id, 'Edit', $atributes); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>  
